        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our skilled volunteers clean, repair, and install fresh software on every device to ensure optimal performance.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We connect refurbished devices with students, families, and individuals who need technology access.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2024 ReByte. All rights reserved. Making technology accessible for everyone.
            </p>
          </div>
        </div>
      </footer>
